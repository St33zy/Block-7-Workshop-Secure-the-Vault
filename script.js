// Create a website popup alert that notifies the user to open vault
...
// console.log() was just messing around with things here

function printMessage() {
    let text = document.getElementById("message").innerHTML = `${num1} - ${num2} - ${num3}`;
}
